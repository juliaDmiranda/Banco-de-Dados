...
CREATE TABLE `cursou` (
  ...
  CONSTRAINT `cursou_ibfk_1` FOREIGN KEY (`aluno`) REFERENCES `aluno` (`id`),
  CONSTRAINT `cursou_ibfk_2` FOREIGN KEY (`disciplina`) REFERENCES `disciplinas` (`cod`)
...
-- Dump completed on 2022-05-06 13:32:44
